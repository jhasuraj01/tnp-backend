...
public class StudentController {
  ...
  public ResponseEntity<Response> getAllStudentsByCompany(
      @Valid @RequestBody GetStudentsByCompanyRequestBody getStudentsByCompanyRequestBody) {
  ...
  public ResponseEntity<Response> getAllStudentsByCompanies(
      @Valid @RequestBody GetStudentsByCompaniesRequestBody getStudentsByCompaniesRequestBody) {
  ...
  public ResponseEntity<List<Student>> createStudents(
      @Valid @RequestBody List<CreateStudentRequestBody> studentRequestBodies) {
    List<Student> students = studentRequestBodies.stream().map(studentRequestBody -> Student.builder()
  ...
  @PutMapping("/")
  public ResponseEntity<List<Response>> updateStudents(
      @Valid @RequestBody ArrayList<UpdateStudentRequestBody> updateStudentRequestBodies) {
